/*
# LightXZ Seed Content

Populates classes (6–10), subjects per class, revision materials, quizzes, and questions
so the app has real content to browse on first load. Read-only data; no security changes.
*/
